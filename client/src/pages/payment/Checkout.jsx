  ...
  const handleSubscription = async (e) => {
    ...
    const options = {
        ...
        handler: async (response) => {
             paymentInfo.razorpay_payment_id = response.razorpay_payment_id;
             paymentInfo.razorpay_subscription_id = response.razorpay_subscription_id;
             paymentInfo.razorpay_signature = response.razorpay_signature

             const res = await dispatch(verifyUserPayment(paymentInfo));
